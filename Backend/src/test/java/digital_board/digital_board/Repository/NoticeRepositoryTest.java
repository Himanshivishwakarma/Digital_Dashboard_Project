...
public class NoticeRepositoryTest {
    ...
    void testGetAllNoticeByUserId() {
        ...
        // are returned
        assertEquals(2, resultPage.getTotalElements()); // Assuming two notices have statuses other than 'disable'
    ...
    void testFindByDepartmentNameInANDcategoriesInAndStatusNotDisable() {
        // Arrange: Create a list of mock notices with different department names, categories, and statuses
        List<Notice> mockNotices = Arrays.asList(
              new Notice("1", "This is an important announcement.",
                        "this is notice descriptions",
                        "General", "HR Department", "2023-11-01", "2023-11-10", null,
   ...
   void  testFindByCategoryInAndDepartmentNameIn(){
     List<Notice> mockNotices = Arrays.asList(
            ...
            when(noticeRepository.findByCategoryInAndDepartmentNameIn(anyList(),anyList(),any(Pageable.class))).thenReturn(mockNotices);

            noticeRepository.findByCategoryInAndDepartmentNameIn(Arrays.asList("General","General"),Arrays.asList("HR Department","HR Department"),PageRequest.of(0, 10));
     ...
     List<Notice> mockNotices = Arrays.asList(
              new Notice("1", "This is an important announcement.",
                ...
                new Notice("2", "This is an important announcement.",
                  ...
                  List<Notice> result  =  noticeRepository.findBycategoriesInAndStatusNotDisable(Arrays.asList("General","General"));
                  assertEquals(mockNotices, result);
   }
 ...
 void  TestfindByDepartmentAndStatusNotDisabled(){
     List<Notice> mockNotices = Arrays.asList(
              new Notice("1", "This is an important announcement.",
                ...
                new Notice("2", "This is an important announcement.",
                        ...
                        "enable"));
                        when(noticeRepository.findBycategoriesInAndStatusNotDisable(anyList())).thenReturn(mockNotices);
                  List<Notice> result  =  noticeRepository.findBycategoriesInAndStatusNotDisable(Arrays.asList("HR Department","HR Department"));
                  assertEquals(mockNotices, result);
 }
  ...
  @Test
   ...
   void testFindByNoticeTitleContainingIgnoreCaseOrDescriptionContainingIgnoreCase(){
       ...
       when(noticeRepository.findByNoticeTitleContainingIgnoreCaseOrDescriptionContainingIgnoreCase(anyString(), anyString(), any(Pageable.class))).thenReturn(pageNotice);    
      Page<Notice> result =  noticeRepository.findByNoticeTitleContainingIgnoreCaseOrDescriptionContainingIgnoreCase("This is an important announcement.", "this is notice descriptions", PageRequest.of(0,10));          
  ...
  void  testFindByStatus(){
    List<Notice>mockNotices = List.of(
                ...
                new Notice("1", "z",
                        ...
                        when(noticeRepository.findByStatus(anyString(), any(Sort.class), any(PageRequest.class))).thenReturn(mockNotices);
  ...
  void testFindByCategoryInAndDepartmentNameInAndStatusInAndCreatedByIn(){
        List<Notice>mockNotices = List.of(
                ...
                new Notice("1", "z",
                        ...
                        "disable"));
                        Page<Notice> pageNotice = new PageImpl<>(mockNotices);
                        when(noticeRepository.findByCategoryInAndDepartmentNameInAndStatusInAndCreatedByIn(anyList(),anyList(),anyList(),anyList(),any(Pageable.class))).thenReturn(pageNotice);
                        Page<Notice> result = noticeRepository.findByCategoryInAndDepartmentNameInAndStatusInAndCreatedByIn(Arrays.asList("categories","categories"),Arrays.asList("categories","categories"), Arrays.asList("categories","categories"),Arrays.asList("categories","categories"),PageRequest.of(0, 10));
                        assertEquals(pageNotice, result);
  }
}
