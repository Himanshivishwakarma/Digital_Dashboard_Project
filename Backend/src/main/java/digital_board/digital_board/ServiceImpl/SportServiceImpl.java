...
public class SportServiceImpl implements SportService{
    ...
    public Sport getSportById(String sportId) {
      Sport sport = sportRepository.findById(sportId).orElseThrow(() -> new ResourceNotFoundException("Sport Id not found"));
      return sport;
    }
    ...
    Sport sports = sportRepository.findById(sportId).orElseThrow(() -> new ResourceNotFoundException("Sport Id not found"));
